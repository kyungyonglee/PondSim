...
namespace Starsky {
  ...
  class AddressedNode : public Node {
    ...
    public:
      ...
      AddressedNode(const my_int addr, std::set<std::string> itemSet, my_int my_index);
      ...
      void CreatePowerlawAttrValue(int num);
      map<int,int> powerlaw_attr_value;
    };
}
#endif
